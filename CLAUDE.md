...
data/products.md                상품 20종 URL — 답글은 주제에 맞는 상품 페이지로 연결
...
- **소재에 맞는 상품이 있으면 답글로 링크.** 상품 20종 5개 군(연애·마음 / 관계의 끝과 다시 / 일·공부 / 재물 / 삶의 자리)은 `data/products.md`. 띠·시의성 등 대응 상품이 없는 소재는 답글 없이 본문만.
