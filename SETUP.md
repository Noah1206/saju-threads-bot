...
GitHub: https://github.com/22500698/saju-threads-bot (비공개, 비밀값 제외)
...
git clone https://github.com/22500698/saju-threads-bot && cd saju-threads-bot   (Node >= 22.9, npm install 불필요)
